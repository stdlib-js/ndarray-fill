...
```javascript
import fill from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-fill@v0.1.0-deno/mod.js';
```
...
[@stdlib/ndarray/fill-by]: https://github.com/stdlib-js/ndarray-fill-by/tree/deno
