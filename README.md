...
```javascript
import fill from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-fill@v0.1.1-esm/index.mjs';
```
...
[@stdlib/ndarray/fill-by]: https://github.com/stdlib-js/ndarray-fill-by/tree/esm
